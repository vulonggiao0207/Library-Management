<%@ Page Language="C#" AutoEventWireup="true" CodeFile="capnhatkhuvuc.aspx.cs" Inherits="admin_capnhatkhuvuc" %>
     ...
     <div id="Sidebar">	
	  ...
	  <div id="Container">
          ...
          <table style="width:400px;margin-left:150px" bgcolor="#E8F3FF">
              ...
              <tr>
                  <td colspan="2">  
                      <asp:GridView ID="KhuVucGridView" runat="server" 
                          AutoGenerateColumns="False" Width="400px" 
                          CellPadding="4" ForeColor="#333333" GridLines="None" 
                          onrowcommand="KhuVucGridView_RowCommand">
                          <AlternatingRowStyle BackColor="White" />
                          <Columns>
                              <asp:BoundField DataField="MaKhuVuc" Visible="False">
                              <ControlStyle Width="1px" />
                              <FooterStyle Width="1px" />
                              <HeaderStyle Width="1px" />
                              <ItemStyle Width="1px" />
                              </asp:BoundField>
                              <asp:BoundField DataField="TenKhuVuc" HeaderText="Tên Khu Vực" />
                              <asp:TemplateField HeaderText="Xóa">
                                  <ItemTemplate>
                                      <asp:ImageButton ID="XoaButton" runat="server" Text="Xóa" Width="25px" 
                                          ...
                                          CommandArgument='<%# Eval("MaKhuVuc") %>' Style="margin-right:5px" 
                                          />
                                  </ItemTemplate>
              ...
              <tr>
                  <td colspan="2">
                      <asp:Label ID="Label1" runat="server" Text="Thêm mới khu vực: " Style="margin-left:0px;"></asp:Label>
         ...
         <%--popup thêm chức vụ--%>
              ...
              PopupControlID="ThemKhuVucPanel" TargetControlID="ThemButton"
              BackgroundCssClass="PopupBackground" CancelControlID="HuyButton"
              DropShadow="true">
              </asp:ModalPopupExtender>     
          <%------%>
        <asp:Panel ID="ThemKhuVucPanel" runat="server" Width="400px" Style="display: none;">            
                <div class="popup_head">Thêm khu vực</div>
                <div class="popup_content">
                    <asp:TextBox ID="ThemKhuVucTextBox" runat="server" Width="260px"></asp:TextBox>
                    <asp:Button ID="ThemKhuVucButton" runat="server" Text="Thêm" Width="50px" 
                        onclick="ThemKhuVucButton_Click" />
        ...
        <asp:Panel ID="ThongBaoPanel" runat="server" Width="400px" Style="display: none;">            
         ...
         <%------ --%>
          ...
          <asp:HiddenField ID="SuaHid" runat="server" />
              ...
              PopupControlID="SuaKhuVucPanel" TargetControlID="SuaHid"
              BackgroundCssClass="PopupBackground" CancelControlID="HuyKhuVucButton"
              DropShadow="true">
              </asp:ModalPopupExtender>           
          <%------%>
        <asp:Panel ID="SuaKhuVucPanel" runat="server" Width="400px" Style="display: none;">            
                <div class="popup_head">Sửa khu vực</div>
                <div class="popup_content">
                    <asp:TextBox ID="SuaTextBox" runat="server" Width="260px"></asp:TextBox>
                    <asp:Button ID="SuaKhuVucButton" runat="server" Text="Lưu" Width="50px" 
                        onclick="SuaKhuVucButton_Click"/>
                    <asp:Button ID="HuyKhuVucButton" runat="server" Text="Hủy" Width="50px" Style="margin-left:10px" />
                </div>
                <div class="popup_bottom"></div>
        </asp:Panel> 
         <%------ --%>

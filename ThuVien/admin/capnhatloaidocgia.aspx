<%@ Page Language="C#" AutoEventWireup="true" CodeFile="capnhatloaidocgia.aspx.cs" Inherits="admin_capnhatloaidocgia" %>
...
<div id="Wrapper">
	...
	<div id="Content">
     <div id="Sidebar">	
		...
		<div id="container_head">Cập nhật loại độc giả</div>
	  <div id="Container">
          ...
          <table style="width:400px;margin-left:150px" bgcolor="#E8F3FF">
              ...
              <tr>
                  <td colspan="2">  
                      <asp:GridView ID="LoaidocgiaGridView" runat="server" 
                          AutoGenerateColumns="False" Width="400px" 
                          CellPadding="4" ForeColor="#333333" GridLines="None" 
                          onrowcommand="LoaidocgiaGridView_RowCommand">
                          <AlternatingRowStyle BackColor="White" />
                          <Columns>
                              <asp:BoundField DataField="MaLoai" Visible="False">
                              <ControlStyle Width="1px" />
                              <FooterStyle Width="1px" />
                              <HeaderStyle Width="1px" />
                              <ItemStyle Width="1px" />
                              </asp:BoundField>
                              <asp:BoundField DataField="TenLoai" HeaderText="Tên loại độc giả" />
                              <asp:TemplateField HeaderText="Xóa">
                                  <ItemTemplate>
                                      <asp:ImageButton ID="XoaButton" runat="server" Text="Xóa" Width="25px" 
                                          ...
                                          CommandArgument='<%# Eval("MaLoai") %>' Style="margin-right:5px" />
                                  </ItemTemplate>
...
/>
              ...
              <tr>
                  <td colspan="2">
                      <asp:Label ID="Label1" runat="server" Text="Thêm mới loại độc giả: " Style="margin-left:0px;"></asp:Label>
        ...
        <asp:Panel ID="ThemLoaiPanel" runat="server" Width="400px" Style="display: none;">            
                <div class="popup_head">Thêm loại độc giả</div>
                <div class="popup_content">
                    <asp:TextBox ID="ThemLoaiTextBox" runat="server" Width="260px"></asp:TextBox>
        ...
        <asp:Panel ID="SuaLoaiPanel" runat="server" Width="400px" Style="display: none;">            
                <div class="popup_head">Sửa loại độc giả</div>
                <div class="popup_content">
                    ...
                    <asp:Button ID="HuyLoaiButton" runat="server" Text="Hủy" Width="50px" Style="margin-left:10px" />
                </div>
                <div class="popup_bottom"></div>
        </asp:Panel> 
         <%------ --%>

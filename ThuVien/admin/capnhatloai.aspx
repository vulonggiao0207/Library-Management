<%@ Page Language="C#" AutoEventWireup="true" CodeFile="capnhatloai.aspx.cs" Inherits="admin_capnhatloaisach" %>
...
<div id="Wrapper">
	...
	<div id="Content">
     <div id="Sidebar">	
		...
		<div id="container_head">Cập nhật loại sách</div>
	  <div id="Container">
          ...
          <table style="width:400px;margin-left:150px" bgcolor="#E8F3FF">
              ...
              <tr>
                  <td colspan="2">  
                      <asp:GridView ID="LoaisachGridView" runat="server" 
                          AutoGenerateColumns="False" Width="400px" 
                          CellPadding="4" ForeColor="#333333" GridLines="None" 
                          onrowcommand="LoaisachGridView_RowCommand" >
                          ...
                          <Columns>
                              ...
                              <asp:BoundField DataField="TenLoai" HeaderText="Tên loại sách" />
...
/>
        ...
        <asp:Panel ID="ThemLoaiPanel" runat="server" Width="400px" Style="display: none;">            
                <div class="popup_head">Thêm loại sách</div>
        ...
        <asp:Panel ID="SuaLoaiPanel" runat="server" Width="400px" Style="display: none;">            
                <div class="popup_head">Sửa loại sách</div>
                <div class="popup_content">
